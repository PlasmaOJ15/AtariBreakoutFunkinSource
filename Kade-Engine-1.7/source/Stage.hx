    ...
    public function new(daStage:String)
    {
        ...
        switch(daStage)
        {
            case 'breakout':
					...
					camZoom = 0.5;
						curStage = 'breakout';
						var bg:FlxSprite = new FlxSprite(-650, -900).loadGraphic(Paths.image('breakout/bg'));
						...
						var stageFront:FlxSprite = new FlxSprite(-650, -900).loadGraphic(Paths.image('breakout/fg'));
