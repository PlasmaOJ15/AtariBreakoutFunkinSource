...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bfbreak':
				var tex = Paths.getSparrowAtlas('breakout/BoyFriend_Assets');
				frames = tex;

				trace(tex.frames.length);

				animation.addByPrefix('idle', 'idle', 24, false);
				animation.addByPrefix('singUP', 'hit', 24, false);
				animation.addByPrefix('singLEFT', 'hit', 24, false);
				animation.addByPrefix('singDOWN', 'hit', 24, false);
				animation.addByPrefix('singRIGHT', 'hit', 24, false);
				...
				animation.addByPrefix('deathLoop', "death loop", 24, false);
			...
			case 'breakout':
				var tex = Paths.getSparrowAtlas('breakout/breakout_assets');
				frames = tex;
				...
				animation.addByPrefix('singDOWN-alt', 'die', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'hit', 24, false);
